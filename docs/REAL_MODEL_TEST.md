...
- 2026-09-16 通过项目 API 再次运行真实应急简报，耗时 149.14 秒，得到 1 个 Evidence、5 个 Entity、6 个 Claim、4 个 Fact、0 个通过校验的 Relation 和 3 个指标候选。
- 上述完整结果已写入“五层抽取验证项目”；API 与 Web 同时重启后结果仍存在，浏览器刷新可自动恢复。
